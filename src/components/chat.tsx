...
import { Item, McpApprovalRequestItem, ToolCallItem, MessageItem, McpListToolsItem } from "@/lib/assistant";
          ...
          <div className="mt-auto space-y-5 pt-4">
            {items.map((item, index) => (
              <React.Fragment key={index}>
                {item.type === "tool_call" ? (
                  <ToolCall toolCall={item as ToolCallItem} />
                ) : item.type === "message" ? (
                  <div className="flex flex-col gap-1">
                    <Message message={item as MessageItem} />
                    {(() => {
                  ...
                  <McpToolsList item={item as McpListToolsItem} />
